...
<script runat="server">
	...
	protected override void OnLoad(EventArgs e)
	{
		...
		this.RegisterAsyncTask(async () => this.Page.AddFormlessScriptContent("SC.util.mergeIntoContext({0:json});", new
		{
			...
			shouldShowUserNameAndPasswordFields = await MembershipWebAuthenticationProvider.IsInternalMembershipEnabledAndHasUser() || CloudWebAuthenticationProvider.IsCloudWebAuthenticationProviderActive(this.Context),
		}));
	}
