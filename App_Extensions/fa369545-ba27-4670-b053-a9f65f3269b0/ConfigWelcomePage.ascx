...
<script src="./App_Extensions/fa369545-ba27-4670-b053-a9f65f3269b0/Scripts/Utilities.js"></script>
<script src="./App_Extensions/fa369545-ba27-4670-b053-a9f65f3269b0/Scripts/Defaults.js"></script>

<div class="AdvancedConfigurationEditorContentPanel"></div>

<script>
	SC.event.addGlobalHandler(SC.event.PreRender, function () {
		SC.service.GetInstanceIdentifierFingerprint(function(thumbprint) {
			SC.ui.setContents(document.querySelector('.AdvancedConfigurationEditorContentPanel'), [
				...
				$configWelcomeBlock(SC.res['AdvancedConfig.ServerInfo'], [
					$span({ _textResource: 'AdvancedConfig.InstanceIdentifierFingerprint'}),
					$span({ innerHTML: ": " + thumbprint }),
				])
			]);
