...
function saveChangeToSessionStorage(configType, element) {
	if (configType === 'WebConfig') {
		...
		if (element.id.indexOf('DefaultSupportSessionInfoAttributes') >= 0 || element.id.indexOf('DefaultAccessSessionInfoAttributes') >= 0) {
...
function buildWebConfigSettingsPage(contentPanel, webConfigSettings) {
	...
	var otherSettingsTable = $table({ className: 'DataTable ConfigDataTable' }, [
		...
		//Acknowledge Message Delay Setting
		$tr([
			$td(
		...
		$tr([
			...
			$td(
				$div({ className: webConfigSettingHasDefaultValue(webConfigSettings, WebConfigDefaults.OtherSettings, 'DuoIntegrationKey') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
				...
				$div({ className: webConfigSettingHasDefaultValue(webConfigSettings, WebConfigDefaults.OtherSettings, 'DuoSecretKey') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
				...
				$div({ className: webConfigSettingHasDefaultValue(webConfigSettings, WebConfigDefaults.OtherSettings, 'DuoApiHostname') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
	...
	SC.ui.setContents(contentPanel, [
		$table({ className: 'DataTable ConfigDataTable' }, [
			...
			$tr([
				...
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'SupportLockMachineOnDisconnect') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
						SC.res['AdvancedConfig.Support'],
						CSS_CLASS_TOGGLE_BLOCK,
						$configToggle(
							...
							null,
							APP_CONFIG,
							setToggle(appConfigSettings.UserInterfaceSettings, 'SupportLockMachineOnDisconnect', null, false, false)
						)
					)
				),
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'AccessLockMachineOnDisconnect') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
						SC.res['AdvancedConfig.Access'],
						CSS_CLASS_TOGGLE_BLOCK,
						$configToggle(
							...
							null,
							APP_CONFIG,
							setToggle(appConfigSettings.UserInterfaceSettings, 'AccessLockMachineOnDisconnect', null, false, false)
						)
					)
				),
				$emptyDataCell()
			...
			$tr([
				$td(
					$configDescriptionBlock(SC.res['AdvancedConfig.ShowEndOfSessionDialog'], SC.res['AdvancedConfig.ShowEndOfSessionDialog.Description'])
				),
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'ShowSessionEndDialogOnExit') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configToggle(
						'ShowSessionEndDialogOnExit',
						null,
						APP_CONFIG,
						setToggle(appConfigSettings.UserInterfaceSettings, 'ShowSessionEndDialogOnExit', null, false, false)
					)
				),
				$emptyDataCell(),
				$emptyDataCell()
	...
	SC.ui.setContents(contentPanel, [
		$table({ className: 'DataTable ConfigDataTable' }, [
			...
			$tr([
				...
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'SupportLockMachineOnConnect') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
						SC.res['AdvancedConfig.Support'],
						CSS_CLASS_TOGGLE_BLOCK,
						$configToggle(
							...
							null,
							APP_CONFIG,
							setToggle(appConfigSettings.UserInterfaceSettings, 'SupportLockMachineOnConnect', null, false, false)
						)
					)
				),
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'AccessLockMachineOnConnect') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configControlBlock(
						SC.res['AdvancedConfig.Access'],
						CSS_CLASS_TOGGLE_BLOCK,
						$configToggle(
							...
							null,
							APP_CONFIG,
							setToggle(appConfigSettings.UserInterfaceSettings, 'AccessLockMachineOnConnect', null, false, false)
						)
					)
				),
				$emptyDataCell()
			...
			$tr([
				$td(
					$configDescriptionBlock(SC.res['AdvancedConfig.AlwaysEndSession'], SC.res['AdvancedConfig.AlwaysEndSession.Description'])
				),
				$td({ className: hasDefaultSettingValue(appConfigSettings.UserInterfaceSettings, AppConfigDefaults.UserInterfaceSettings, 'AlwaysEndSessionOnExit') ? '' : CSS_CLASS_TOGGLE_CELL_NOT_DEFAULT },
					$configToggle(
						'AlwaysEndSessionOnExit',
						null,
						APP_CONFIG,
						setToggle(appConfigSettings.UserInterfaceSettings, 'AlwaysEndSessionOnExit', null, false, false)
					)
				),
				$emptyDataCell(),
				$emptyDataCell()
