...
namespace ScreenConnect
{
	...
	public class AppearanceService : WebServiceBase
	{
		...
		{
			"Page.Background" => 1100,
			"GuestWelcomePanel.Message" => 1000,
			"GuestWelcomePanel.Heading" => 900,
			"GuestActionPanel.CodeSession.Heading" => 800,
			"ApplicationTitle" => 700,
			"ApplicationIcon16" => 600,
			"ApplicationIcon32" => 500,
			"LogoPanel.Icon" => 400,
			"LogoPanel.IconLight" => 300,
			"UnderControlBannerTextFormat" => 200,
			"BlankMonitorMessageFormat" => 100,
			_ => 0,
		};
		...
		[DemandLicense(BasicLicenseCapabilities.AdministerAppearance)]
		public async Task SaveResource(string resourceType, string key, bool isImage, [ActivityTraceIgnore] IDictionary<string, string> overrideValuesByCultureKey)
		{
